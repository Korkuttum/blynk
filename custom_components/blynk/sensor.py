...
class BlynkSensor(BlynkEntity, SensorEntity):
    ...
    def __init__(self, coordinator, pin, config, pin_mapping=None):
    ...
    def _parse_value(self, value):
        ...
        _LOGGER.debug("Raw value from Blynk for pin %s (MQTT: %s): %s (type: %s)", 
    ...
    def native_value(self):
        ...
        _LOGGER.debug("Pin %s (MQTT: %s) - Raw: %s, Parsed: %s", 
                     self._pin, self._get_mqtt_topic(), raw_value, parsed_value)
        return parsed_value
